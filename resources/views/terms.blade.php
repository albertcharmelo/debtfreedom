...
<body>
    ...
    <section class="terms">
        ...
        <p>These terms and conditions outline the rules and regulations for the use of debtfreedom usa's Website,
            located at www.debtfreedom-usa.com.</p>

        <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
            debtfreedom-usa if you do not agree to take all of the terms and conditions stated on this page.</p>
        ...
        <p>We employ the use of cookies. By accessing debtfreedom-usa, you agreed to use cookies in agreement with the
            debtfreedom usa's Privacy Policy. </p>
        ...
        <p>Unless otherwise stated, debtfreedom usa and/or its licensors own the intellectual property rights for all
            material on debtfreedom-usa. All intellectual property rights are reserved. You may access this from
            debtfreedom-usa for your own personal use subjected to restrictions set in these terms and conditions.</p>
        ...
        <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
            areas of the website. debtfreedom usa does not filter, edit, publish or review Comments prior to their
            presence on the website. Comments do not reflect the views and opinions of debtfreedom usa,its agents and/or
            affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the
            extent permitted by applicable laws, debtfreedom usa shall not be liable for the Comments or for any
        ...
        <p>debtfreedom usa reserves the right to monitor all Comments and to remove any Comments which can be considered
        ...
        <p>You hereby grant debtfreedom usa a non-exclusive license to use, reproduce, edit and authorize others to use,
        ...
        <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
            ...
            debtfreedom usa; and (d) the link is in the context of general resource information.</p>
        ...
        <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website,
            you must inform us by sending an e-mail to debtfreedom usa. Please include your name, your organization
        ...
        <p>No use of debtfreedom usa's logo or other artwork will be allowed for linking absent a trademark license
            agreement.</p>
    ...
    <div class="back_home">
        <button type="button" class="back_home_buttom"> <a href="/" class=" text-decoration-none"
